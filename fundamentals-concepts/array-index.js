...
console.log(whiteIndex , redIndex , blueIndex , blackIndex);

// now i'm practicing checking element by index.
var indexSix = colors[6];
var indexFive = colors[5];
var indexFour = colors[4];
var indexThree = colors[3];
var indexTwo = colors[2];
